...
class VerifiedDevices(Model):
    user_id = CharField()
    device_id = CharField()
    device_key_type = CharField()
    device_key = CharField()
    class Meta:
        constraints = [SQL("UNIQUE(user_id,device_id,device_key)")]

class IgnoredDevices(Model):
    user_id = CharField()
    device_id = CharField()
    device_key_type = CharField()
    device_key = CharField()
...
class BlacklistedDevices(Model):
    user_id = CharField()
    device_id = CharField()
    device_key_type = CharField()
    device_key = CharField()
...
class InitialSync(Model):
    initial_sync_done = BooleanField(default=False)
...
class DKeys(Model):
    ...
    class Meta:
        constraints = [SQL("UNIQUE(device_id,device_key_type)")]
